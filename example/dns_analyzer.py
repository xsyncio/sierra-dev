...
invoker = sierra.InvokerScript(
    name="dns_analyzer", description="Comprehensive DNS record enumeration and analysis"
)
...
def run(
    domain: sierra.Param[
        str | None, sierra.SierraOption(description="Domain to analyze", mandatory="MANDATORY")
    ],
    ...
    if rows:
        result = sierra.Table(headers=["Record Type", "Value", "Reverse DNS"], rows=rows)
    else:
