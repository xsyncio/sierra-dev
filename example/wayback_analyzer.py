...
invoker = sierra.InvokerScript(
    name="wayback_analyzer", description="Analyze website history using Wayback Machine"
)
...
def run(
    ...
    limit: sierra.Param[
        int | None,
        sierra.SierraOption(
            description="Number of recent snapshots to show (default 10)", mandatory="OPTIONAL"
        ),
    ] = 10,
) -> None:
    """
    ...
    result = sierra.Table(headers=["Date/Info", "URL"], rows=rows)
