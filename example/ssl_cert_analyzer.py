...
invoker = sierra.InvokerScript(
    name="ssl_cert_analyzer", description="Analyze SSL/TLS certificate information"
)
...
def run(
    hostname: sierra.Param[
        str | None,
        sierra.SierraOption(
            description="Hostname to analyze SSL certificate", mandatory="MANDATORY"
        ),
    ],
    port: sierra.Param[
        int | None,
        sierra.SierraOption(description="Port number (default 443)", mandatory="OPTIONAL"),
    ] = 443,
) -> None:
    """
